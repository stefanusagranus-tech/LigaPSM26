...
if "portal_prep_ready" in st.session_state and st.session_state.portal_prep_ready:
    ...
    # =========================================================================
        ...
        # =========================================================================
        if st.session_state["campaign_sub_page"] == "view_buku_pencapaian":
        ...
        # =========================================================================
        # 🛎️ GERBANG DEFAULT (ELSE): MEJA RESEPSIONIS UTAMA (ANTI-HILANG & ANTI-REJECT)
        # =========================================================================
        else:
            # Jika halaman bukan buku 1 atau buku 2, PAKSA lobi utama ini yang merender!
            ...
            with col_lobby1:
                with st.container(border=True):
                    ...
                    if st.button("Lihat Status ➔", use_container_width=True, key="btn_lobby_buruan_else_engine"):
            ...
            with col_lobby2:
                with st.container(border=True):
                    ...
                    if st.button("Ambil Quest ➔", use_container_width=True, key="btn_lobby_misi_else_engine"):
            ...
            st.markdown("<div class='rpg-back-btn-box'>", unsafe_allow_html=True)
            if st.button("⬅️ KEMBALI KE KEMAH PERSIAPAN", use_container_width=True, key="btn_exit_lobby_else_engine"):
                st.session_state.current_camp_menu = "main"
                st.rerun()
            st.markdown("</div>", unsafe_allow_html=True)
