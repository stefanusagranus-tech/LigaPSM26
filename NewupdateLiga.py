...
if "portal_prep_ready" in st.session_state and st.session_state.portal_prep_ready:
    ...
    # =========================================================================
        ...
        if "page_direction" not in st.session_state:
            st.session_state["page_direction"] = "right"  # default arah buka

        TOTAL_SHEETS = 5

        # 🎨 SUNTIKKAN CSS DENGAN TEMA MEDIEVAL RPG & ANIMASI 3D PAGE FLIP DINAMIS
        st.markdown(
            f"""
            <style>
                ...
                /* Animasi dinamis berdasarkan arah navigasi (Maju/Mundur) */
                .kitab-misi-page-wrapper .rpg-book-page:nth-child(1) {{
                    transform-origin: left center !important;
                    animation: {'flipPageLeft' if st.session_state['page_direction'] == 'right' else 'flipPageRight'} 0.6s cubic-bezier(0.25, 1, 0.5, 1) forwards !important;
                }}

                .kitab-misi-page-wrapper .rpg-book-page:nth-child(2) {{
                    transform-origin: right center !important;
                    animation: {'flipPageRight' if st.session_state['page_direction'] == 'right' else 'flipPageLeft'} 0.6s cubic-bezier(0.25, 1, 0.5, 1) 0.1s forwards !important;
                    opacity: 0;
                }}
                ...
                .kitab-misi-page-wrapper .open-stat-row {{ 
                    ...
                    border-bottom: 1px dashed rgba(133,77,14,0.25) !important; 
        ...
        if page_num == 1:
            ...
            st.session_state["page_direction"] = (
                "left"  # Animasi balik ke kiri (mundur)
            )
            st.session_state["kitab_misi_page"] -= 1
            st.rerun()
        ...
        with col_nav2:
        st.markdown(
            f"<p style='text-align:center; color:#854d0e; font-family:monospace;"
        ...
        if page_num < TOTAL_SHEETS:
            ...
            st.session_state["page_direction"] = "right"  # Animasi buka ke kanan (maju)
            st.session_state["kitab_misi_page"] += 1
            st.rerun()
        ...
        rows_psm_13 = "".join(
            [format_row(i + 1, n, s) for i, (n, s) in enumerate(dummy_9_personil[:3])]
        )
        rows_psm_49 = "".join(
            [format_row(i + 4, n, s) for i, (n, s) in enumerate(dummy_9_personil[3:])]
        )
        ...
        html_open_tugas = textwrap.dedent(f"""
            <div class="rpg-open-book-container">
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_psm_13}
                    <p class="open-page-footer">Halaman Kiri • PSM 1-3</p>
                </div>
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_psm_49}
                    <p class="open-page-footer">Halaman Kanan • PSM 4-9</p>
                </div>
            </div>
            """)
        ...
        html_open_tugas = textwrap.dedent(f"""
            <div class="rpg-open-book-container">
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_pps_13}
                    <p class="open-page-footer">Halaman Kiri • PPS 1-3</p>
                </div>
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_pps_49}
                    <p class="open-page-footer">Halaman Kanan • PPS 4-9</p>
                </div>
            </div>
            """)
        ...
        sueger_data = [
            (n, f"{int(s.replace(' Pcs',''))+5} Pcs") for n, s in dummy_9_personil
        ]
        rows_sueger_13 = "".join(
            [format_row(i + 1, n, s) for i, (n, s) in enumerate(sueger_data[:3])]
        )
        rows_sueger_49 = "".join(
            [format_row(i + 4, n, s) for i, (n, s) in enumerate(sueger_data[3:])]
        )
        ...
        html_open_tugas = textwrap.dedent(f"""
            <div class="rpg-open-book-container">
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_sueger_13}
                    <p class="open-page-footer">Halaman Kiri • Sueger 1-3</p>
                </div>
                <div class="rpg-book-page">
                    ...
                    <div class="open-book-divider"></div>
                    {rows_sueger_49}
                    <p class="open-page-footer">Halaman Kanan • Sueger 4-9</p>
                </div>
            </div>
            """)
