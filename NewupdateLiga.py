...
css_bingkai_terkunci = """
<style>
    /* Paksa container Streamlit tunduk pada ukuran kartu agar tidak pecah */
    ...
    .rpg-fullscreen-wrapper { text-align: center; font-family: monospace; width: 100%; margin: 0 auto; box-sizing: border-box; }
    ...
    /* Wajib mengunci dimensi luar kartu agar flexbox Streamlit tidak merusak struktur */
    .flip-card-wrapper { background-color: transparent !important; width: 330px !important; height: 520px !important; perspective: 1000px !important; margin: 15px auto !important; cursor: pointer !important; display: block !important; box-sizing: border-box !important; }
    .flip-card-inner { position: relative !important; width: 100% !important; height: 100% !important; text-align: center !important; transition: transform 0.8s cubic-bezier(0.4, 0, 0.2, 1) !important; transform-style: preserve-3d !important; }

    /* 🔄 Mekanisme Pemicu Putaran Kartu */
    #card-trigger:checked ~ .flip-card-wrapper .flip-card-inner { transform: rotateY(180deg) !important; }

    /* Pengunci Latar Belakang Gelap dan Backface Sisi Kartu */
    .card-face { 
    ...
    /* ✨ PENGEMBALIAN BINGKAI EMAS UTUH (DIPAKSA EMAS MULTIKLAS) */
    .card-front-design { 
        border: 4px double #d97706 !important; 
        box-shadow: 0 12px 35px rgba(217, 119, 6, 0.3), inset 0 0 25px rgba(217, 119, 6, 0.05) !important; 
    ...
    .char-hero-name { color: #ffffff !important; font-size: 22px !important; font-weight: 900 !important; margin: 0 !important; letter-spacing: 2px !important; text-shadow: 0 0 8px rgba(255,255,255,0.1) !important; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 90%; }
    .char-hero-level-badge { background: rgba(217, 119, 6, 0.15); color: #fbbf24; font-size: 11px; font-weight: 800; padding: 3px 12px; border-radius: 20px; border: 1px solid rgba(217, 119, 6, 0.4); margin-top: 5px; margin-bottom: 20px; letter-spacing: 0.5px; white-space: nowrap; }

    /* Komponen Bar Status (Mencegah Teks Patah/Meluber Kebawah) */
    .rpg-stat-container { width: 100% !important; margin-bottom: 12px !important; text-align: left !important; box-sizing: border-box !important; }
    .rpg-stat-header { display: flex !important; justify-content: space-between !important; color: #94a3b8 !important; font-size: 11px !important; font-weight: bold !important; margin-bottom: 4px !important; font-family: monospace !important; letter-spacing: 0.5px !important; white-space: nowrap !important; }
    
    .rpg-bar-bg { background-color: #05070a !important; height: 12px !important; border-radius: 6px !important; overflow: hidden !important; border: 1px solid rgba(217, 119, 6, 0.15) !important; box-shadow: inset 0 2px 4px rgba(0,0,0,0.6) !important; width: 100% !important; box-sizing: border-box !important; }
    .rpg-bar-fill-psm { background: linear-gradient(90deg, #ef4444, #f97316) !important; height: 100% !important; border-radius: 6px !important; filter: drop-shadow(0 0 4px #f97316) !important; }
    .rpg-bar-fill-pps { background: linear-gradient(90deg, #3b82f6, #06b6d4) !important; height: 100% !important; border-radius: 6px !important; filter: drop-shadow(0 0 4px #06b6d4) !important; }
    .rpg-bar-fill-sueger { background: linear-gradient(90deg, #10b981, #34d399) !important; height: 100% !important; border-radius: 6px !important; filter: drop-shadow(0 0 4px #34d399) !important; }
...
"""
st.markdown(css_bingkai_terkunci, unsafe_allow_html=True)
