...
if "portal_prep_ready" in st.session_state and st.session_state.portal_prep_ready:
    ...
    # =========================================================================
        ...
        # =========================================================================
            ...
            # --- 🎮 3. CONTROL CENTER: ENGINE NAVIGASI TOMBOL ALAS KAKI BUKU (ULTIMATE OVERRIDER) ---
            st.markdown("<br>", unsafe_allow_html=True)
            
            # 🎨 JURUS PAMUNGKAS: HANCURKAN STRUKTUR VERTIKAL UNIVERSAL & PAKSA KIRI-KANAN SEJAJAR BUKU
            st.markdown(
                """
                <style>
                    /* Tembak wadah kontainer horizontal pembungkus kolom Streamlit khusus area navigasi ini */
                    div[data-testid="stHorizontalBlock"]:has(button[key*="btn_nav_pack_"]) {
                        display: flex !important;
                        flex-direction: row !important; /* WAJIB KUNCI: Paksa wajib berjejer kiri-kanan horizontal */
                        justify-content: space-between !important;
                        align-items: center !important;
                        gap: 15px !important; /* Jarak renggang antar tombol */
                        width: 100% !important;
                        max-width: 580px !important; /* PRESISI: Mengunci lebar tombol sejajar rata air dengan buku */
                        margin: 0 auto !important; /* Kunci mati pas di tengah halaman */
                    }

                    /* Paksa kedua kolom anak di dalamnya agar membagi area secara adil (48% - 48%) */
                    ...
                    /* SULAP UTAMA TOMBOL: Hancurkan wujud neon biru universal & ciutkan ukuran mengikuti buku */
                    div[data-testid="stColumn"] button[key*="btn_nav_pack_"] {
                        width: 100% !important;
                        max-width: 100% !important;
                        min-height: 42px !important;
                        height: 42px !important;
                        background: #854d0e !important; /* Warna Cokelat Emas Kayu Perkamen */
                        color: #f4eae1 !important;
                        border: 2px solid #5c4033 !important;
                        border-radius: 6px !important;
                        font-family: monospace !important;
                    ...
                    div[data-testid="stColumn"] button[key*="btn_nav_pack_"]:active,
                    div[data-testid="stColumn"] button[key*="btn_nav_pack_"]:focus {
                        background: #5c4033 !important;
                        color: #ffffff !important;
                        filter: none !important;
                    }
            ...
            # Buat baris kolom murni menggunakan native Streamlit layout (100% AMAN ANTI-LOGOUT)
            col_nav1, col_nav2 = st.columns(2)

            with col_nav1:
                # HALAMAN 1: Berfungsi sebagai Tombol EXIT Utama menuju meja resepsionis
                if current_page == 1:
