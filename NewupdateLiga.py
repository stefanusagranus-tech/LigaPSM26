...
# --- TAB MASTER DATA & PENGATURAN ---
  ...
  # SUB TAB 4: INPUT & MASTER PPS & SUEGER (Diperbarui ke SALES_PPS & PERIODE_PPS)
  with tab_m4:
    st.markdown(
        ...
        if btn_submit_pps:
          if not pps_id or not pps_nama_promo:
            ...
            try:
              ...
              # Disimpan ke tabel/sheet SALES_PPS dan PERIODE_PPS secara sinkron
