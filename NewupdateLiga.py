...
def generate_pdf_report(title, sections_data, generated_time_str):
    """
    Generate PDF report summary penjualan (versi anti-error emoji).
    """
    try:
        ...
        # --- HELPER: bersihkan karakter non-latin1 ---
        def _clean(text):
            if text is None:
                return ""
            # Convert emoji & karakter khusus ke teks biasa
            replacements = {
                "—": "-", "–": "-", "•": "*", "→": "->", "←": "<-",
                "≥": ">=", "≤": "<=", "×": "x", "…": "...",
                "“": '"', "”": '"', "‘": "'", "’": "'",
            ...
            # Filter sisa karakter yang tidak bisa di-render latin-1
            return text.encode("latin-1", "replace").decode("latin-1")

        # --- HEADER ---
        pdf.set_font("Helvetica", "B", 16)
        pdf.set_text_color(20, 40, 90)
        pdf.cell(0, 10, _clean(title), ln=True, align="C")

        pdf.set_font("Helvetica", "I", 9)
        pdf.set_text_color(120, 120, 120)
        pdf.cell(0, 6, _clean(f"Generated: {generated_time_str}"),
                 ln=True, align="C")
        ...
        for section in sections_data:
            ...
            for line in sec_lines:
                ...
                # Hitung lebar efektif (190mm = 210 - 15 - 5)
                pdf.set_x(15)
                try:
                    pdf.multi_cell(w=180, h=5, text=clean_line,
                                   align="L", new_x="LMARGIN", new_y="NEXT")
                except Exception:
                    # Fallback kalau tetap error
                    pdf.cell(0, 5, clean_line[:120], ln=True)
        ...
        pdf.set_text_color(120, 120, 120)
        pdf.cell(0, 5, "Generated automatically via LigaPSM System",
                 align="C")
