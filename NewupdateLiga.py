...
# --- TAB 06: INPUT & RESET DATA ---
    ...
    with tab_in4:
        ...
        if not is_admin:
            ...
            # Req 1: Tanggal terkunci sesuai batas periode
            ...
            if filtered_si_m.empty:
                ...
                # Render Form Multi Input secara rapi (Grid 2 Kolom)
                multi_input_values = {}
                ...
                if st.button("💾 Simpan Semua Data Penjualan Multi-Input", use_container_width=True, key="btn_save_multi"):
                    ...
                    if inserted_count > 0:
                        # Append semua row sekaligus, sinkron toko, dan simpan permanen ke GS
